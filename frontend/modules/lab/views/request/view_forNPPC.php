            ...
            $.post('/lab/request/saverequestransaction', {
               ...
               if(result == 'Success'){
                   ...
                   //location.reload();
                    ...
                    //krajeeDialog.alert(result);
                    BootstrapDialog.show({
                        title: "Generated",
                        message: "<p class='note' style='text-align:center;font-weight:bold;color:#000000;font-size:15px;'>Request Reference # and Sample Code Successfully Generated!</p>",
                        buttons: [
                            {
                                label: 'OK',
                                ...
                                action: function(thisDialog){
                                    ...
                                    BootstrapDialog.show({
                                        title: "OneLab",
                                        message: "<p class='note' style='text-align:center;font-weight:bold;color:#0b632d;font-size:20px;'>OneLab system launching successful!</p><div style='text-align:center;'><img style='width: 550px; height: 180px;' src='/images/nppclogo.jpg'></div>",
                                        buttons: [
                                            {
                                                label: 'OK',
                                                action: function(thisDialog){
